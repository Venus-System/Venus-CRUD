...
public interface ProfileTagRepository extends JpaRepository<ProfileTag, Long> {
    ...
    Optional<ProfileTag> findByName(String name);
    Slice<ProfileTag> findByCategory(ProfileTagCategory category, Pageable pageable);
    Slice<ProfileTag> findAllBy(Pageable pageable);
    List<ProfileTag> findByCategoryInOrderByNameAsc(Collection<ProfileTagCategory> categories);
}
